 ...
 * Plugin URI:        https://wordpress.org/plugins/wp-webcam-widget-shortcode/
 ...
 * Author URI:        https://www.procida.info
 * Update URI:        https://wordpress.org/plugins/wp-webcam-widget-shortcode/
 * Text Domain:       wpwws
...
function wpwws_page(){
	...
	<div class="wrap">
		<h2>WP Webcam Widget and Shortcode Info</h2>
...
class wpwws_widget extends WP_Widget{
    ...
    function upd_<?php echo $myHashID; ?>(){
		jQuery('#<?php echo $myHashID; ?>').attr('src', '<?php echo $webcamurl; ?>'+'?nc='+Math.random());
	}
	</script>
	<?php 
